...
Cuando estamos jugando parques y un jugador lanza dos dados, el resultado solo es posible de observar después de haber realizado la acción de lanzarlos. 
...
data <- data.frame(Tamano_Muestra = tamanos_muestra, Probabilidad = probabilidades)

# Gráfico de convergencia con ggplot2
ggplot(data, aes(x = Tamano_Muestra, y = Probabilidad)) +
  geom_line(color = "blue", size = 1) + 
  geom_hline(yintercept = 6/36, color = "red", linetype = "dashed") +
  labs(title = "Convergencia de la Probabilidad de Suma 7 al Lanzar Dos Dados",
       x = "Tamaño de Muestra",
       y = "Probabilidad de Suma 7") +
  theme_minimal() +
  theme(
